...
export default function StoresCardT2(props) {
  ...
  return (
    <>
      <div  className='md:hidden cursor-pointer flex-1 border border-[#D5D5D5] px-[16px] py-[16px] rounded-md' onClick={()=>{navigate('/root/store')}}>
      ...
      <div className='hidden cursor-pointer md:flex gap-[126px] p-[16px] rounded-[8px] shadow-lg'>
