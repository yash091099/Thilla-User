...
console.log(props,'-------------------props t2 card')
  ...
  return (
    <>
    <div className="ml-3" onClick={()=>{setStoreId(props.id);navigate('/root/store')}} >

      <div  className='md:hidden cursor-pointer flex-1 border border-[#D5D5D5] px-[16px] py-[16px] rounded-md' >
